...
<body>
    ...
    <main>
        <div class="overflow-hidden">
            <img class="product-jumbotron rellax" src="./img/gallery/doors/french_1.jpg">
        </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-4 text-center product-img">
                        ...
                        <div class="product-images">
                            <a href="./img/doors/french.jpg" class="d-none">View all Photos</a>
                            <a href="./img/gallery/doors/french_1.jpg" class="d-none">Open popup 2</a>
                        </div>
                    </div>
                        ...
                        <div class="tab-content pt-4 pb-5" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <ul>
                                    ...
                                    <li>Mortised or surface applied flush bolts on the inactive door leaf.</li>
                                    <li>Completely weather-stripped for maximum security and protection against the elements</li>
                                </ul>
                                ...
                                <p>AAMA/WDMA/CSA 101/I.S.2/A440-05</p>
