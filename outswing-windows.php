...
<head>
    ...
    <title>Solii | Outswing Windows</title>
</head>
...
<body>
    ...
    <main>
        <div class="overflow-hidden">
            <img class="product-jumbotron rellax" src="./img/gallery/outswing_1.jpg">
        </div>
        <section class="content-area">
            <div class="container p-3 p-md-5">
                <h1 class="text-uppercase mb-md-5">Outswing Casement</h1>
                <div class="row">
                        ...
                        <div class="tab-content pt-4 pb-5" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <ul>
                                    ...
                                    <li>Unique design and double weather-stripping</li>
                                ...
                                <ul>
                                    <li>Unique rustic solid brass ball bearing hinges, friction stay and sash lock</li>
                                </ul>

                                <h3 class="py-3">Screen</h3>
                                <ul>
                                    <li>In-swing wood frame screen with fiberglass, stainless steel or bronze mesh</li>
                                    <li>Roll down screen available upon request</li>
                                </ul>
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <ul class="list-unstyled download-links">
                                    <li><a href="/img/Windows/Outswing/BELISLE---Outswing-Casements.pdf" target="_blank">Product Brochure <i class="far fa-arrow-to-bottom"></i></a></li>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".sub-menu__1 a:nth-child(2)").addClass("active");
        });
